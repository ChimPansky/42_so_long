...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   sl_create_structs_bonus.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tkasbari <thomas.kasbarian@gmail.com>      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/19 17:25:34 by tkasbari          #+#    #+#             */
/*   Updated: 2023/12/04 11:45:07 by tkasbari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	t_sl_game *game, bool p_moveable, t_sl_point *p_point)
{
	...
	if (p_point->symbol == SL_MAP_PLAYER || p_point->symbol == SL_MAP_PATROL)
		new_unit->moveable = true;
	new_unit->pos = p_point;
	new_unit->sprite_state = 1;
	new_unit->next = NULL;
	return (new_unit);
}
