...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   sl_init_structs_bonus.c                            :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: tkasbari <thomas.kasbarian@gmail.com>      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/19 17:16:36 by tkasbari          #+#    #+#             */
/*   Updated: 2023/11/28 13:33:26 by tkasbari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sl_init_graphics(t_sl_game *game, t_mlx_graphics *mlx)
{
	...
	mlx->mlx_img_patrol = NULL;
	mlx->mlx_img_token_1 = NULL;
	mlx->mlx_img_token_2 = NULL;
	...
	mlx->mlx_img_moves = NULL;
	while (i < 10)
		mlx->mlx_img_digits[i++] = NULL;
}
